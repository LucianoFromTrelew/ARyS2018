\begin{titlepage}
    ...
    \HRule \\[0.4cm]
    {\huge \bfseries Bitcoin}\\[0.4cm] % Title of your document
    {\large \bfseries Qué elementos de criptografía utiliza la primer criptomoneda que existió}\\[0.4cm] % Title of your document
    \HRule \\[1.5cm]
